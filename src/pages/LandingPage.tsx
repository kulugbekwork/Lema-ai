        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <span className="text-xl sm:text-2xl font-bold text-gray-900">LEMA AI</span>
            </div>
      ...
      <main>
        <section className="py-12 sm:py-16 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto px-4 sm:px-0">
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-blue-100">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-600 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
                  <Sparkles className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">AI Course Generation</h3>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-green-100">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Interactive Lessons</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 px-4 sm:px-0">How It Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 max-w-5xl mx-auto px-4 sm:px-0">
              <div className="text-center">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 text-white text-xl sm:text-2xl font-bold">
                  1
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Describe Your Goal</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">AI Creates Your Course</h3>
                <p className="text-sm sm:text-base text-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Start Learning</h3>
                <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Personalized Learning Paths</h4>
                      <p className="text-sm sm:text-base text-gray-600">Courses adapted to your goals and learning style</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Learn Anything</h4>
                      <p className="text-sm sm:text-base text-gray-600">From programming to languages, business to arts</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-gray-900 mb-1">Always Available</h4>
                      <p className="text-sm sm:text-base text-gray-600">Learn at your own pace, anytime, anywhere</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-white">
                  <div className="absolute top-6 right-6 sm:top-8 sm:right-8 w-16 h-16 sm:w-24 sm:h-24 border-2 border-white/20 rounded-3xl rotate-12"></div>
                  <div className="absolute bottom-6 left-6 sm:bottom-8 sm:left-8 w-12 h-12 sm:w-16 sm:h-16 border-2 border-white/20 rounded-2xl -rotate-12"></div>
                  <Zap className="w-12 h-12 sm:w-16 sm:h-16 mb-6 sm:mb-8" />
                  <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Ready to Transform Your Learning?</h3>
                  ...
                  <button
                    onClick={onGetStarted}
                    className="bg-white text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-sm sm:text-base w-full sm:w-auto"
                  >
                    Start Learning
                  </button>
                </div>
